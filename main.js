...
products.forEach((p) => {
    ...
    card.innerHTML = `
     ...
     <buttonm class="btn" onclick="addToWishlist(${p.id})">❤</button>
    ...
    list.forEach((product) => {
        ...
        card.innerHTML = `
         ...
         <div class="card-actions">
            ...
            <button class="btn" onclick="addToWishlist(${product.id})">❤</button>
...
function addToCart(id) {
    ...
    alert("Product added to acrt!");
}

// Event listner for search input
searchInput.addEventListener("input", () => {
    const term = searchInput.ariaValueMax.toLowerCase();
...
sortSelect.addEventListener("change", () => {
    ...
    if (value === "priceLow") {
        ...
        sorted.sort((a, b) => a.category.localCompare(b.category)); // Sort by category
    }
